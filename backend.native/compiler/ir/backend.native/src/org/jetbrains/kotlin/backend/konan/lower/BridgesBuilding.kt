...
private fun IrBuilderWithScope.returnIfBadType(
    value: IrExpression,
    type: IrType,
...
private fun IrBlockBodyBuilder.buildTypeSafeBarrier(
    function: IrFunction,
...
private fun Context.buildBridge(
    startOffset: Int,
    endOffset: Int,
